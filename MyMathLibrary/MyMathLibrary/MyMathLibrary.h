...
namespace MyMathLibrary
{
	...
	public:
		...
		float DegreeRadianConversion(int a_type, float a_numToConvert);
	...
	public:
		...
		MyMatrix3x3(vector<vector<float>>& a_matrix);
	...
	public:
		...
		//Function for Cross Product
		float CrossProduct(const My3DVector &a_3DVector);
	...
	public:
		...
		bool operator == (const My4DVector &a_equalsEquals);
